...
* [Автоматизация статического анализа бинарных файлов с помощью Ghidra API на Python](/Reverse/GhidraAPI-Python.md)
...
* [SC09:2025 Insecure Randomness в смарт-контрактах](/WEB/Insecure_Randomness_Smart_Contracts.md)
